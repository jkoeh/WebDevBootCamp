document.addEventListener('DOMContentLoaded', () => {
  ...
  start.addEventListener('click', () => {
    ...
    startGame(wordCount, words);
  });

  var toggleClasses = (element, ...classListToAdd) => classListToAdd.forEach((classToAdd) => element.classList.toggle(classToAdd));

  function startGame(wordCount, words) {
  ...
  var getRandomValues = (array, numVals=wordCount) => shuffle(array).slice(0, numVals);
