...
Write a function called areAllNumbersFinite which accepts an array and returns true if every single value in the array is a finite number, 
...
function areAllNumbersFinite(arg) {
    return arg.every(Number.isFinite);
}
