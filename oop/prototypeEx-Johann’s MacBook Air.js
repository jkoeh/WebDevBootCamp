...
//which is an empty array. This will involve you going back and adding an additional 
//line of code to your Person constructor you previously created in exercise 1.
...
is an object construced from the Person constructor 
...
Person.prototype.addToFamily = function(member){
    if(member instanceof Person){
        if(!(this.family.includes(member))){
